...
describe('VRT Example with Puppeteer and Spectre', function() {
  it('should take a screenshot of the footer logo and post screenshots to spectre', async function() {
    await puppeteer.takeScreenshot('https://www.spotify.com/se/', '.footer-logo a', 'footerLogoWithMocha', 1280, 1024, false);
    await spectre.postScreenshots('Spotify', 'Logo', 'footerLogoWithMocha', '1280');
  });
});
